...
export class StudentService {
    ...
    public selectHighestPointStudent(): Observable<Student[]> {
        return this.http.get<Student[]>(`${this.apiServerUrl}/student/highest`);
    }

    public selectRandomStudentWinners(): Observable<Student[]> {
        return this.http.get<Student[]>(`${this.apiServerUrl}/student/random`);
    }
